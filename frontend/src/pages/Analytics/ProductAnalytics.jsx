  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.chartsRow}>
        {/* Chart 1: Product Quote Count (All Statuses) */}
        <Card style={styles.chartCard}>
          <CardHeader style={styles.cardHeader}>
            <CardTitle style={styles.cardTitle}>Total Products & Quote Count</CardTitle>
          </CardHeader>
            ...
            <table style={styles.table}>
              <thead>
                <tr style={styles.tableHeaderRow}>
                  ...
                  <th style={{ ...styles.tableHeader, textAlign: 'right' }}>Customer Count</th>
                  <th style={{ ...styles.tableHeader, textAlign: 'right' }}>Won Revenue</th>
                  <th style={{ ...styles.tableHeader, textAlign: 'right' }}>% of Total</th>
                </tr>
              </thead>
              <tbody>
                {detailed_performance.map((product, index) => (
                  <tr key={index} style={styles.tableRow}>
                    ...
                    <td style={{ ...styles.tableCell, textAlign: 'right' }}>{product.customer_count}</td>
                    <td style={{ ...styles.tableCell, textAlign: 'right' }}>${product.won_revenue.toLocaleString()}</td>
                    <td style={{ ...styles.tableCell, textAlign: 'right' }}>{product.percentage_of_total.toFixed(2)}%</td>
                  </tr>
                ))}
              </tbody>
            </table>
