...
const CombinedInsightsFilterPanel = ({ filters, onFilterChange }) => {
    ...
    <div style={styles.container}>
      <div style={styles.header}>
        <div style={styles.headerLeft}>
          ...
          <span style={styles.headerTitle}>Insights Filters</span>
        </div>
      </div>

      <div style={styles.filtersGrid}>
        {/* Time Period Filter - Only filter for Combined Insights */}
...
export default CombinedInsightsFilterPanel;