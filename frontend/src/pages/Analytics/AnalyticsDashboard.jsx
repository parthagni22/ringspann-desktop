  ...
  return (
    <div style={styles.container}>
      <div style={styles.innerContainer}>
        ...
        {/* Tabs Container - NO GLOBAL FILTERS */}
        <div style={styles.tabsContainer}>
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            {/* Product Tab - with Product-specific filters */}
            <TabsContent value="product">
              <ProductAnalytics 
                filters={productFilters} 
                onFilterChange={setProductFilters}
                key={`product-${JSON.stringify(productFilters)}`} 
              />
            </TabsContent>

            {/* Finance Tab - with Finance-specific filters */}
            <TabsContent value="finance">
              <FinanceAnalytics 
                filters={financeFilters} 
                onFilterChange={setFinanceFilters}
                key={`finance-${JSON.stringify(financeFilters)}`} 
              />
            </TabsContent>

            {/* Customer Tab - with Customer-specific filters */}
            <TabsContent value="customer">
              <CustomerAnalytics 
                filters={customerFilters} 
                onFilterChange={setCustomerFilters}
                key={`customer-${JSON.stringify(customerFilters)}`} 
              />
            </TabsContent>

            {/* Combined Insights Tab - with minimal filters */}
            <TabsContent value="insights">
              <CombinedInsights 
                filters={insightsFilters} 
                onFilterChange={setInsightsFilters}
                key={`insights-${JSON.stringify(insightsFilters)}`} 
              />
            </TabsContent>
          </Tabs>
        </div>
