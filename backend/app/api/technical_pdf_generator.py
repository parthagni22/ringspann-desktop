...
#     # Row 1: Main section headers
#     section_row = [
#         Paragraph('<b>SL<br/>No.</b>', header_style),  # Column 0 - spans rows 0-2
#         Paragraph('<b>Tag<br/>number</b>', header_style),  # Column 1 - spans rows 0-2
#         Paragraph('<b>Application</b>', header_style),  # Column 2 - spans rows 0-2
#         Paragraph('<b>Customer Datasheet</b>', header_style),  # Spans shaft/torque/speed columns
#         '', '', '', '', '', '', '', '', '', '', '', '', '',
#         Paragraph('<b>Operating<br/>hours<br/>daily</b>', header_style),  # Column 17 - spans rows 0-2
#         Paragraph('<b>Direction of rotation<br/>from drive side</b>', header_style),  # Spans columns 18-19 in row 0
#         '',
#         Paragraph('<b>RINGSPANN Product</b>', header_style),  # Spans product columns
#         '', ''
#     ]
...
#     subsection_row = [
#         '',  # SL No (spanned from row 0)
#         '',  # Tag number (spanned from row 0)
#         '',  # Application (spanned from row 0)
#         Paragraph('<b>Shaft diameter</b>', header_style),  # Spans 4
#         '', '', '',
#         Paragraph('<b>Torque (Mn)</b>', header_style),  # Spans 4
#         '', '', '',
#         Paragraph('<b>Speed</b>', header_style),  # Spans 6
#         '', '', '', '', '',
#         '',  # Operating hours (spanned from row 0)
#         Paragraph('<b>Main<br/>drive</b>', header_style),  # Column 18 - spans rows 1-2
#         Paragraph('<b>Auxiliary<br/>drive</b>', header_style),  # Column 19 - spans rows 1-2
#         Paragraph('<b>Product<br/>code</b>', header_style),  # Column 20 - spans rows 1-2
#         Paragraph('<b>Size</b>', header_style),  # Column 21 - spans rows 1-2
#         Paragraph('<b>Technical<br/>points</b>', header_style),  # Column 22 - spans rows 1-2
#     ]
...
#         # Speed
#         Paragraph('<b>Main drive<br/>Min<br/>RPM</b>', header_style),
#         Paragraph('<b>Main drive<br/>Rated<br/>RPM</b>', header_style),
#         Paragraph('<b>Main drive<br/>Max<br/>RPM</b>', header_style),
#         Paragraph('<b>Auxiliary drive<br/>Min<br/>RPM</b>', header_style),
#         Paragraph('<b>Auxiliary drive<br/>Rated<br/>RPM</b>', header_style),
#         Paragraph('<b>Auxiliary drive<br/>Max<br/>RPM</b>', header_style),
#         '',  # Operating hours (spanned from row 0)
#         '',  # Direction Main drive (spanned from row 1)
#         '',  # Direction Auxiliary drive (spanned from row 1)
#         '',  # Product code (spanned from row 1)
#         '',  # Size (spanned from row 1)
#         '',  # Technical points (spanned from row 1)
#     ]
...
#         # ROW 0: Main section headers
#         ('SPAN', (0, 0), (0, 2)),    # SL No spans rows 0-2
#         ('SPAN', (1, 0), (1, 2)),    # Tag number spans rows 0-2
#         ('SPAN', (2, 0), (2, 2)),    # Application spans rows 0-2
#         ('SPAN', (3, 0), (16, 0)),   # "Customer Datasheet" spans columns 3-16 in row 0
#         ('SPAN', (17, 0), (17, 2)),  # Operating hours spans rows 0-2
#         ('SPAN', (18, 0), (19, 0)),  # "Direction of rotation from drive side" spans columns 18-19 in row 0
...
#         ('SPAN', (7, 1), (10, 1)),   # Torque spans 4 columns
#         ('SPAN', (11, 1), (16, 1)),  # Speed spans 6 columns
#         ('SPAN', (18, 1), (18, 2)),  # Main drive spans rows 1-2
#         ('SPAN', (19, 1), (19, 2)),  # Auxiliary drive spans rows 1-2
#         ('SPAN', (20, 1), (20, 2)),  # Product code spans rows 1-2
#         ('SPAN', (21, 1), (21, 2)),  # Size spans rows 1-2
#         ('SPAN', (22, 1), (22, 2)),  # Technical points spans rows 1-2
...
#         ('SPAN', (5, 0), (19, 0)),   # "Customer Datasheet" spans columns 5-19 (20 cols)
